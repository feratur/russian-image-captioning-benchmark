...
To reproduce the results a Docker-enabled machine with NVIDIA GPU (CUDA 11.3 [compatible](https://docs.nvidia.com/deploy/cuda-compatibility/index.html) drivers are required) can be used:
```
